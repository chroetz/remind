...
kableDefault(summaryData, "Overall Relative Variation Summary of Prices")
```
...
kableDefault(medianRV, "Median Relative Variation of Prices over Regions")
```
...
kableDefault(quart3RV, "3rd Quartile of Relative Variation of Prices over Regions")
```
