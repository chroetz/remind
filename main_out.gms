...
cm_regipol_slope_beforeTarget "switch to generate a co2 price trajectory in the regipol module with a different slope in the first years than in the last years before the target year"
...
cm_esubGrowth = middle; !! def = middle
