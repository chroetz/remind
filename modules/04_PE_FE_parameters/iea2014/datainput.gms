...
p04_prodCoupleGlob("pebiolc","sebiochar","biocharHighTech","seel") = -0.16; !! based on Roberts et al. 2010 (Life Cycle Assessment of Biochar Systems: Estimating the Energetic, Economic, and Climate Change Potential)
p04_prodCoupleGlob("pebiolc","sebiochar","biocharHighTech","seliqbio") = 0.71; !! based on Elmously et al. 2019 (Upscaling of Thermo-Catalytic Reforming Process from Lab to Pilot Scale)
p04_prodCoupleGlob("pebiolc","sebiochar","biocharHighTech","segabio") = 0.77; !! based on Elmously et al. 2019 (Upscaling of Thermo-Catalytic Reforming Process from Lab to Pilot Scale)
p04_prodCoupleGlob("pebiolc","sebiochar","biocharMedTech","segabio") = 1.0; !! based on Roberts et al. 2010 (Life Cycle Assessment of Biochar Systems: Estimating the Energetic, Economic, and Climate Change Potential)
